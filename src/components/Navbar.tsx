...
const Navbar = () => {
  ...
  const socialLinks = [
    ...
    { name: "Discord", icon: "discord", url: "https://discord.gg/56SWvhqXuE" },
  ];
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-lg border-b border-border/50">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center">
          <img src={logo} alt="CityBack Logo" className="h-10 w-auto" />
        </Link>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <a href="https://discord.gg/56SWvhqXuE" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
