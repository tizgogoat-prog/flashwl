    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-transparent">
      <div className="container mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center shrink-0">
          <img src={logo} alt="Cityland WL Logo" className="h-12 w-auto" />
        </Link>
          ...
          {navLinks.map((link) => {
            ...
            return (
              <Link
                key={link.path}
                to={link.path}
                className="relative pb-1 text-sm font-semibold tracking-[0.15em] uppercase transition-colors duration-200 group"
              >
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <a href="https://www.youtube.com/@CityBackk" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
              </svg>
            </a>
            <a href="https://discord.gg/EEwZz2bbxU" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
